export function SkeletonCard() {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 animate-pulse dark:border-slate-700 dark:bg-slate-800">
      ...
      <div className="mt-5 h-10 w-full rounded-xl bg-slate-200 dark:bg-slate-700" />
    </div>
  );
}
  ...
  return (
    <div className="space-y-4">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="rounded-2xl border border-slate-200 bg-white p-6 animate-pulse dark:border-slate-700 dark:bg-slate-800">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 space-y-3">
              <div className="h-6 w-1/2 rounded-lg bg-slate-200 dark:bg-slate-700" />
              <div className="h-4 w-1/3 rounded-lg bg-slate-200 dark:bg-slate-700" />
            </div>
